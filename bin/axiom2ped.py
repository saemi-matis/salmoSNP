...
if args.population == "Iceland":
    if args.individuals != None or args.rivers != None or args.individuals != None and args.rivers != None:
        pass
    else:
...
def main():
    ...
    if args.population == "Iceland":
        ...
        riversInfo_dict = {}
    write_plinkFiles(genotypes_dict, ssatrackAnnotation_dict, riversInfo_dict, individualsInfo_dict, args.out_name, args.population)
...
def write_plinkFiles(genotypes_dict, ssatrackAnnotation_dict, riversInfo_dict, individualsInfo_dict, out_name, population):
    print("#INFO: Writing MAP File")
    probe_order = write_mapFile(ssatrackAnnotation_dict, genotypes_dict, out_name)
...
def write_mapFile(ssatrackAnnotation_dict, genotypes_dict, out_name):
